    ...
    card.innerHTML = `
      ...
      <div class="card-body">
        ...
        <div class="card-actions">
          ...
          <button class="smallAdd" data-id="${p.id}" style="padding:10px 12px; border-radius:10px; border: 1px solid rgba(255,255,255,0.12); background: rgba(255,255,255,0.04); color:#e8eefc; font-weight:900; cursor:pointer;">Add</button>
        </div>
      </div>
    `;
